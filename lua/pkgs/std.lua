...
S.packer = {
    ...
    exists = function ( self ) ---@param self StdPackerCfg
        return not (vim.fn.empty( vim.fn.glob( self.plugindir ) ) > 0)
    end,
    bootstrapped = false,
    bootstrap = function ( self ) ---@param self StdPackerCfg
    ...
    ready = function(self) ---@param self StdPackerCfg
        local good_string =
    ...
    startup = function ( self ) ---@param self StdPackerCfg
